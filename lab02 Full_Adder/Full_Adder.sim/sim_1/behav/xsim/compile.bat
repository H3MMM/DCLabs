...
REM
REM Generated by Vivado on Sat Nov 15 22:49:08 +0800 2025
...
echo "xvlog --incr --relax -prj AddSub_vlog.prj"
call xvlog  --incr --relax -prj AddSub_vlog.prj -log xvlog.log
