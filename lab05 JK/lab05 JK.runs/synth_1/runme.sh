...
HD_PWD='D:/Labs/DCLabs/code/lab05 JK/lab05 JK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LS76.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LS76.tcl
