...
HD_PWD='D:/Labs/DCLabs/code/lab05 JK/lab05 JK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LS76.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LS76.tcl -notrace
