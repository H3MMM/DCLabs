...
REM
REM Generated by Vivado on Fri Nov 21 15:21:13 +0800 2025
...
echo "xvlog --incr --relax -prj MUX8_1test_vlog.prj"
call xvlog  --incr --relax -prj MUX8_1test_vlog.prj -log xvlog.log
