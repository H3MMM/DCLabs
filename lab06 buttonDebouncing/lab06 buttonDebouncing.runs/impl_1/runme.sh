...
HD_PWD='D:/Labs/DCLabs/code/lab06 buttonDebouncing/lab06 buttonDebouncing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buttonDebouncing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buttonDebouncing.tcl -notrace
