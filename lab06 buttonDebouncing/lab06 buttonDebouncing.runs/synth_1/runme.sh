...
HD_PWD='D:/Labs/DCLabs/code/lab06 buttonDebouncing/lab06 buttonDebouncing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buttonDebouncing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buttonDebouncing.tcl
