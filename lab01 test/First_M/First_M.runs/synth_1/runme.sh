...
HD_PWD='D:/DCLabs/code/First_M/First_M.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log First_M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source First_M.tcl
