...
HD_PWD='D:/Labs/DCLabs/code/lab07 DigitTube/lab07 DigitTube.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Digit_Tube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Digit_Tube.tcl -notrace
