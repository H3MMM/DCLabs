...
HD_PWD='D:/Labs/DCLabs/code/lab07 DigitTube/lab07 DigitTube.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digit_Tube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digit_Tube.tcl
